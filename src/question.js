export class Question {
    static create(question) {
        return fetch('https://js-practice-7d52c.firebaseio.com/questions.json', {
            method: 'POST',
    ...
    static fetch(token) {
        ...
        return fetch(`https://js-practice-7d52c.firebaseio.com/questions.json?auth=${token}`)
            .then(response => response.json())
            .then(response => {
                if (response.error) {
